  ...
  return (
    <>
      <style>
        ...
        .hero-button-primary:hover{background-color:#f9fafb}
  ...
  {[...Array(6)].map((_, index) => (
    <SwiperSlide key={index}>
      <div className="w-full max-w-sm bg-white shadow-md rounded-xl p-4 text-left mx-auto">
                  ...
                  {/* Sarlavha */}
                  <h3 className="text-lg font-semibold mt-4">Qopqoq – skovorodka</h3>
                  ...
                  <div className="mt-4">
                    ...
                    <select className="w-full border border-gray-300 rounded px-3 py-2 text-sm">
                      <option value="8">8 litr</option>
                    </select>
                  </div>

                  {/* Narx qismi */}
                  <div className="mt-3 text-sm">
                    <span className="line-through text-gray-400 mr-2">180 so‘m</span>
                    <span className="font-semibold text-orange-500">170 so‘m</span>
                    <span className="block text-gray-500 mt-1">To‘plam narxi</span>
                  </div>

                  {/* Tugmalar */}
                  <div className="mt-4 flex items-center justify-between">
                    <button className="bg-orange-500 hover:bg-orange-400 text-white px-6 py-2 rounded-full shadow">
                      Sotib olish
                    </button>
